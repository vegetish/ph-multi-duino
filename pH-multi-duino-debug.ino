//Lines marked with DEBUGX are modified/created for debug purposes
...
void turb_control() 
{ 
    //int turbidity = analogRead(TURBIDITY_SENSOR_PIN); //DEBUGX
...
BLYNK_WRITE(6)  // Changes are set by the actions application itself (this is reading from a widget) //DEBUGX
{ 
    turbidity = param.asFloat(); 
}
